...
react_production.startTransition = function (scope) {
  ...
  try {
    ...
    "object" === typeof returnValue &&
      ...
      returnValue.then(noop$5, reportGlobalError$1);
  } catch (error) {
...
function GameBoard() {
  const [gameId, setGameId] = reactExports.useState(localStorage.getItem("gameId") || "");
  const [playerId, setPlayerId] = reactExports.useState(localStorage.getItem("playerId") || "");
  const [gameInfo, setGameInfo] = reactExports.useState(null);
  const [shipCells, setShipCells] = reactExports.useState(/* @__PURE__ */ new Set());
  const [myBoard, setMyBoard] = reactExports.useState(Array(10).fill().map(() => Array(10).fill(null)));
  const [enemyBoard, setEnemyBoard] = reactExports.useState(Array(10).fill().map(() => Array(10).fill(null)));
  const saveIds = () => {
  ...
  const createGame = async () => {
    ...
    try {
      setGameInfo(
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "loading-message", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: "⌛ Создание игры..." }) })
      );
      const response = await fetch(API_URL, {
        ...
        credentials: "include"
        // Для куков, если используется авторизация
      });
      if (!response.ok) {
      ...
      setGameInfo(
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "success-message", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: "✅ Игра создана!" }),
      ...
      setGameInfo(
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "error-message", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: "❌ Ошибка создания" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { whiteSpace: "pre-line" }, children: errorMessage }),
          error.message && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            "(",
            error.message,
            ")"
          ] })
  ...
  const joinGame = async () => {
    const gameId2 = prompt("Введите ID игры для подключения:");
    if (!gameId2) {
      alert("Необходимо ввести ID игры");
      return;
    }
    try {
      const response = await fetch(`/join_game?_=${Date.now()}`, {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({ game_id: gameId2 })
      });
      if (!response.ok) {
      ...
      setGameInfo(
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: "✅ Успешное подключение" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            "Game ID: ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { onClick: () => copyText(gameId2), style: { color: "#0066cc", cursor: "pointer" }, children: gameId2 })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            "Player ID: ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { onClick: () => copyText(data.player_id), style: { color: "#009933", cursor: "pointer" }, children: data.player_id })
          ] })
        ] })
      );
    } catch (error) {
      setGameInfo(
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { color: "red" }, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: "❌ Ошибка подключения" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: error.message })
        ] })
      );
  ...
  const sendShips = async () => {
    ...
    try {
      const res = await fetch("/set_ships", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
          ...
          if (data.result === "hit") {
            ...
            if (data.sunk && Array.isArray(data.adjacent)) {
              ...
              data.adjacent.forEach(({ x: adjX, y: adjY }) => {
                if (adjY >= 0 && adjY < newBoard.length && adjX >= 0 && adjX < newBoard[0].length) {
...
Подробности в консоли`);
    ...
    function bfs(start) {
      ...
      while (queue.length > 0) {
        ...
        for (const neighbor of neighbors) {
          ...
          if (coords.some((c) => c.x === neighbor.x && c.y === neighbor.y) && !visited.has(key)) {
            visited.add(key);
            queue.push(neighbor);
          }
        }
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "app", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { children: "Морской Бой" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "controls", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: saveIds, children: "Сохранить" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "boards", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "board-container", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { children: "Моё поле (расстановка)" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "board", children: myBoard.map((row, y) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "row", children: row.map((cell, x) => renderCell(cell, x, y, false, handleMyBoardClick)) }, y)) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "board-container", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { children: "Поле врага (стрельба)" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "board", children: enemyBoard.map((row, y) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "row", children: row.map((cell, x) => renderCell(cell, x, y, true, shoot)) }, y)) })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "actions", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: sendShips, children: "Готово (Отправить корабли)" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: createGame, children: "Создать игру" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: joinGame, children: "Присоединиться к игре" })
    ] }),
    gameInfo && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "game-info", children: gameInfo })
  ] });
}

function App() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(GameBoard, {});
}
